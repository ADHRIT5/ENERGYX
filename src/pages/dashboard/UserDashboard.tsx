          ...
          <TabsContent value="overview" className="space-y-6">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <div className="mt-4">
                  <Button className="w-full" onClick={() => navigate("/coaches")}>
                    Book New Session
                  </Button>
                </div>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-center py-8">
                  ...
                  <h3 className="text-lg font-semibold mb-2">Explore Our Coaches</h3>
                  ...
                  {favoriteCoaches.map((coach) => (
                    <div key={coach.id} className="p-4 border rounded-lg">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Button size="sm" onClick={() => navigate(`/book/${coach.id}`)}>
                          Book Session
                        </Button>
                      </div>
                    </div>
