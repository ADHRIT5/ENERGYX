        ...
        <Card className="w-full max-w-md text-center">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              <Button className="w-full" onClick={() => navigate("/dashboard/user")}>
                Go to Dashboard
              </Button>
              <Button variant="outline" className="w-full" onClick={() => navigate("/coaches")}>
      ...
      <header className="bg-white dark:bg-gray-800 border-b">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <button
            ...
            className="flex items-center space-x-2 bg-transparent border-none cursor-pointer hover:text-blue-600"
          >
